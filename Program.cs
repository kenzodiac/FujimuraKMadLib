...
//Peer Review by: Griffin Parker: Works great and the code is very well organized!
...
while (repeatProgram == true) {
    ...
    Console.WriteLine("Please give me a person's name: ");
    string name1 = Console.ReadLine();

    Console.WriteLine("Great. Now give me a verb. A verb is an action like 'dance' or 'run': ");
    string verb1 = Console.ReadLine();

    Console.WriteLine("Now, write the name of an athletic sport: ");
    string sport1 = Console.ReadLine();

    Console.WriteLine("Now give me the name of a musical genre: ");
    string musicGenre1 = Console.ReadLine();

    Console.WriteLine("Excellent. Now tell me the name of a type of animal: ");
    string pet1 = Console.ReadLine();

    Console.WriteLine("Okay. Now give me a second name: ");
    string petName1 = Console.ReadLine();

    Console.WriteLine("Now, give me the name of a third person: ");
    string name2 = Console.ReadLine();

    Console.WriteLine("Now give me a second verb: ");
    string verb2 = Console.ReadLine();

    Console.WriteLine("Wonderful! We're almost there. Now, give me the name of a hobby: ");
    string hobby1 = Console.ReadLine();

    Console.WriteLine("Great. Now, give me the name of a second musical genre: ");
    string musicGenre2 = Console.ReadLine();

    Console.WriteLine("Thank you. That's all! Here is the story you helped to write: \n");
    ...
    Console.WriteLine("Thank you for playing, I hope you enjoyed the story.\nWould you like to play again? Y/N: ");
    ...
    while (repeatAnswerCounter == true) {
        ...
        if (repeatAnswer == "Y" || repeatAnswer == "y") {
            ...
            Console.WriteLine("I do not understand that input. Please answer with Y/N");
